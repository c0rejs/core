...
const DEFAULT_INDENT = 4,
    listIndentation = {
        "handlers": {
            listItem ( node, parent, context, safeOptions ) {
                ...
                let bullet = context.options.bullet || "-";

                if ( parent && parent.type === "list" && parent.ordered ) {
                    const index = parent.children.indexOf( node ),
                        start = typeof parent.start === "number"
                            ? parent.start
                            : 1;
                ...
                if ( value ) {
                    ...
                    const targetIndentSize = typeof context.options.indent === "number"
                            ? context.options.indent
                            : DEFAULT_INDENT,
                        indentPrefix = " ".repeat( targetIndentSize );
    ...
    toMarkdownOptions = {
        ...
        // custom option for `listIndentation` extension
