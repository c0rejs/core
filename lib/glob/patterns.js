...
export default class GlobPatterns {
    ...
    constructor ( { strict = true, caseSensitive = true, allowNegatedPatterns = true, allowBraces = true, allowGlob = true, allowBrackets = true, allowGlobstar = true, allowExtglob = true, allowMatchBasename, allowIfEmpty, ignoreNegatedPatterns } = {} ) {
        ...
        this.#allowIfEmpty = Boolean( allowIfEmpty );
    ...
    test ( testPath, { prefix, normalize, listMode } = {} ) {
        ...
        TEST: if ( listMode ) {
            ...
            // allow by default
            if ( !this.#hasAllowedPatterns && this.#allowIfEmpty ) {
                allow = true;
            }
