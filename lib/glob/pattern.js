...
export default class GlobPattern {
    ...
    constructor ( pattern, { prefix, strict = true, caseSensitive = true, allowNegatedPatterns = true, allowBraces = true, allowGlob = true, allowBrackets = true, allowGlobstar = true, allowExtglob = true, allowGlobalBasename } = {} ) {
    ...
    #buildRegExp () {
        ...
        // match basename
        if ( isBasename && this.#allowGlobalBasename ) {
            if ( this.#prefix ) {
