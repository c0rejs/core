...
export default class GlobPattern {
    ...
    constructor ( pattern, { prefix, strict = true, absolutePatterns, normalizePatterns, caseSensitive = true, allowNegatedPatterns = true, allowBraces = true, allowGlob = true, allowBrackets = true, allowGlobstar = true, allowExtglob = true, allowGlobalBasename } = {} ) {
