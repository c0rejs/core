...
class Passwords {
    ...
    get defaultBitStrength () {
        return DEFAULT_BIT_STRENGTH;
    }
    ...
    generateRandomPassword ( { alphabet = DEFAULT_ALPHABET, bitStrength = DEFAULT_BIT_STRENGTH, length } = {} ) {
        ...
        return {
            ...
            "strong": passwordBitStrength >= bitStrength,
            alphabet,
            usedAlphabetsSize,
            usedCharBitStrength,
    ...
    checkPassword ( password, { alphabet, bitStrength = DEFAULT_BIT_STRENGTH } = {} ) {
        alphabet = this.getAlphabet( alphabet );
