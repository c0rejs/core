...
export default class IpRanges extends Events {
    ...
    getRandomAddressV4 () {
        return new IpAddress( this.#getRanges4().getRandomValue() );
    }

    getRandomAddressV6 () {
        return new IpAddress( this.#getRanges6().getRandomValue() );
    }
    ...
    #getRanges4 () {
        if ( !this.#ranges4 ) {
            this.#ranges4 = new Ranges( [ ...this.#rangeTree4.values().map( ipRange => ipRange.range ) ] );
        }
    ...
    #getRanges6 () {
        if ( !this.#ranges6 ) {
            this.#ranges6 = new Ranges( [ ...this.#rangeTree6.values().map( ipRange => ipRange.range ) ] );
        }
