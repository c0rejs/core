...
export default class IpRange {
    ...
    includes ( range ) {
        ...
        if ( this.family !== range.family ) return false;

        return range.firstAddress.value >= this.firstAddress.value && range.lastAddress.value <= this.lastAddress.value;
    }
    ...
    inside ( range ) {
        ...
        return this.firstAddress.value >= range.firstAddress.value && this.lastAddress.value <= range.lastAddress.value;
    }
    ...
    intersects ( range ) {
        ...
        if ( this.lastAddress.value >= range.firstAddress.value && this.lastAddress.value <= range.lastAddress.value ) return true;
