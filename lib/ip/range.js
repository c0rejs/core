...
export default class IpRange {
    ...
    constructor ( range, prefix ) {
        ...
        // array of ip addresses
            ...
            this.#firstAddress = IpAddress.new( range[ 0 ] );
            this.#lastAddress = IpAddress.new( range[ 1 ] );
    ...
    intersects ( ipRange ) {
        ...
        return this.range.intersects( ipRange.range );
    }
    ...
    contains ( ipRange ) {
        ...
        return this.range.contains( ipRange.range );
    }
    ...
    isCoveredBy ( ipRange ) {
        ...
        return this.range.isCoveredBy( ipRange.range );
    }
    ...
    concat ( ipRange ) {
        ...
        if ( this.contains( ipRange ) ) {
            return this;
        }
        else if ( this.isCoveredBy( ipRange ) ) {
            return ipRange;
        }
        else if ( this.intersects( ipRange ) || this.isConsecutiveWith( ipRange ) ) {
