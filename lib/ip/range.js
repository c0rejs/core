...
export default class IpRange {
    ...
    includes ( range ) {
        ...
        if ( range.firstAddress.value >= this.firstAddress.value && range.lastAddress.value <= this.lastAddress.value ) return true;
    ...
    inside ( range ) {
        ...
        if ( this.firstAddress.value >= range.firstAddress.value && this.lastAddress.value <= range.lastAddress.value ) return true;
