...
export default class Uuid {
    ...
    static v4 () {
        ...
        // fallback for insecure context
            ...
            const bytes = RandomValues.default.getRandomUint32Array( 4, { "copy": false } );
    ...
    static v7 () {
        ...
        [ bytes[ 2 ], bytes[ 3 ] ] = RandomValues.default.getRandomUint32Array( 2, { "copy": false } );

        // init counter
        if ( !UUIDV7_COUNTER ) {
            UUIDV7_COUNTER = RandomValues.default.getRandomUint16() & 0xFFF;
        }
    ...
    get uint8Array () {
        if ( !this.#uint8Array ) {
            ...
            if ( this.#string ) {
                ...
                // FIXME [engine:node@>=26.0.0]: enable in node 26
