...
export default class Numeric {
    ...
    static getRandomNumeric ( { minPrecision, maxPrecision, scale } = {} ) {
        ...
        var value = randomValues.getRandomInt( min, max );
