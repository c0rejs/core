...
export default class Numeric {
    ...
    round ( scale ) {
        if ( this.isInteger ) {
            ...
            if ( scale ) {
                ...
                if ( !this.#rounded ) {
                    this.#rounded = this.#clone( this.#DECIMAL.round() );
                }
    ...
    trunc ( scale ) {
        if ( this.isInteger ) {
            ...
            if ( scale ) {
                ...
                if ( !this.#truncated ) {
                    this.#truncated = this.#clone( this.#DECIMAL.trunc() );
                }
    ...
    floor ( scale ) {
        if ( this.isInteger ) {
            ...
            if ( scale ) {
                ...
                if ( !this.#floored ) {
                    this.#floored = this.#clone( this.#DECIMAL.floor() );
                }
    ...
    ceil ( scale ) {
        if ( this.isInteger ) {
            ...
            if ( scale ) {
                ...
                if ( !this.#ceiled ) {
                    this.#ceiled = this.#clone( this.#DECIMAL.ceil() );
                }
    ...
    #toPrecision ( decimal, precision, scale, roundingMode, moduloMode ) {
        ...
        if ( precision == null ) {
            ...
            throw new TypeError( "Precision must be number > 0" );
        }
        ...
        if ( roundingMode == null ) {
            ...
            throw new TypeError( "Rounding mode value is not valid" );
        }
        ...
        if ( moduloMode == null ) {
            ...
            throw new TypeError( "Modulo mode value is not valid" );
        }
        ...
        if ( scale == null ) {
            ...
            if ( scale > precision ) {
                throw new TypeError( "Scale must be integer <= precision" );
            }

            maxIntegerPlaces = precision - scale;
        }
        else {
            throw new TypeError( "Scale must be positive integer" );
        }
        ...
        if ( realIntegerPlaces > maxIntegerPlaces ) {
            throw new RangeError( "Numeric precision is out of range" );
        }
