...
import { isValidMonthName, isValidTimeZoneName, isValidWeekdayName } from "#lib/dates";
...
export default {
    ...
    "weekday-name": {
        "type": "string",
        validate ( value ) {
            return isValidWeekdayName( value );
        },
    },
    ...
    "timezone-name": {
        "type": "string",
        validate ( value ) {
            return isValidTimeZoneName( value );
        },
    },
