...
function compareDates ( fromDate, toDate ) {
    ...
    const units = {
        ...
        "hours": toDate.hour - fromDate.hour,
        "minutes": toDate.minute - fromDate.minute,
        "seconds": toDate.second - fromDate.second,
        "milliseconds": toDate.millisecond - fromDate.millisecond,
        "microseconds": toDate.microsecond - fromDate.microsecond,
        "nanoseconds": toDate.nanosecond - fromDate.nanosecond,
    };
