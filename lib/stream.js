...
const contentLengthProperty = Symbol(),
    contentTypeProperty = Symbol(),
    filenameProperty = Symbol(),
    lastModifiedProperty = Symbol();
...
Object.defineProperties( stream.Stream.prototype, {
    ...
    "setContentType": {
        ...
        value ( value ) {
            if ( value == null ) {
                ...
                throw new Error( "Content type should be a String" );
            }
    ...
    "setLastModified": {
        ...
        value ( value ) {
            if ( value == null ) {
                this[ lastModifiedProperty ] = undefined;
            }
            else if ( value instanceof Date ) {
                this[ lastModifiedProperty ] = value;
            }
            else {
                throw new Error( "Last modified should be a date" );
            }
    ...
    [ Symbol.for( "nodejs.util.inspect.custom" ) ]: {
        ...
        value ( depth, options, inspect ) {
            ...
            if ( this.lastModified ) spec.lastModified = this.lastModified;
...
Object.defineProperties( stream.Readable.prototype, {
    ...
    "toBlob": {
        ...
        async value ( { maxLength, type } = {} ) {
            ...
            if ( type === undefined ) type = this.contentType;
    ...
    "toTmpFile": {
        ...
        async value ( { maxLength, ...tmpFileOptions } = {} ) {
            ...
            if ( tmpFileOptions.type === undefined ) tmpFileOptions.type = this.contentType;
            if ( tmpFileOptions.name === undefined ) tmpFileOptions.name = this.filename;
            if ( tmpFileOptions.lastModified === undefined ) tmpFileOptions.lastModified = this.lastModified;
