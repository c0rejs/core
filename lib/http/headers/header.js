...
export default class Header {
    ...
    clone () {
        const header = new this.constructor( this.#headerOriginalName ),
            value = this.value;

        header[ VALUE_PROPERTY ] = Array.isArray( value )
            ? [ ...value ]
            : value;
        ...
        if ( value ) {
            if ( SINGLE_VALUE_HEADERS.has( this.#headerName ) ) {
                ...
                if ( this.valuesSeparator ) {
                    ...
                    this[ VALUE_PROPERTY ].push( value );
    ...
    #parse () {
        ...
        if ( this[ VALUE_PROPERTY ] ) {
            ...
            // parse
            const fields = this._parse( this[ VALUE_PROPERTY ], this.#parser );
