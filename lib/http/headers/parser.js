...
const OWS = String.raw`[ \t]*`,
    ...
    KEY = String.raw`(?<key>${ QUOTED_STRING }|${ UNQUOTED_KEY })`,

    // bare item
    BARE_ITEM = String.raw`(?<value>${ HTTP_DATE_PATTERN }|${ STRING })`;

const REG_EXPS = {
    "COMMA_SEPARATOR": new RegExp( String.raw`^${ OWS }${ OWS },` ),
    "SEMICOLON_SEPARATOR": new RegExp( String.raw`^${ OWS }${ OWS };` ),

    "KEY_VALUE": new RegExp( String.raw`^${ OWS }${ KEY }(?:${ OWS }=${ OWS }${ BARE_ITEM })?${ SEPARATOR }` ),

    "BARE_ITEM": new RegExp( String.raw`^${ OWS }${ BARE_ITEM }${ SEPARATOR }` ),

    "PARAMETER": new RegExp( String.raw`^${ OWS };${ OWS }${ KEY }(?:${ OWS }=${ OWS }${ BARE_ITEM })?${ SEPARATOR }` ),
};
