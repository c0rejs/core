...
export default class Message {
    ...
    addAcceptEncodingMiddleware ( { headers, compress, zlibOptions } = {} ) {
        if ( this.#isDestroyed ) throw new Error( "Message is destroyed" );
        ...
        this.addMiddleware( async message =>
            acceptEncodingMiddleware( message, encoding, {
                compress,
                zlibOptions,
            } ) );
...
async function acceptEncodingMiddleware ( message, encoding, { compress, zlibOptions } ) {
