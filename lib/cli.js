...
export default class Cli {
    ...
    constructor ( config, { allowPartialShort, allowPartialCommand } = {} ) {
        this.#allowPartialShort = Boolean( allowPartialShort );
        this.#allowPartialCommand = Boolean( allowPartialCommand );
    ...
    // properties
    get allowPartialShort () {
        return this.#allowPartialShort;
    }

    get allowPartialCommand () {
        return this.#allowPartialCommand;
    }
    ...
    async #parseCommands () {
        ...
        const possibleCommands = this.#commands.getCommand( command, {
            "allowPartialShort": this.allowPartialShort,
            "allowPartialCommand": this.allowPartialCommand,
        } );
