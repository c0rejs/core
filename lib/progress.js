...
export default class Progress {
    ...
    constructor ( { maxValue, showStatus = true, calculateElapsed = true, outputStream = process.stdout, tty, unitStyle, showBar = true, locale, bytes, updateInterval } = {} ) {
    ...
    incrementProgress ( { value, elapsed } = {} ) {
        if ( !this.#stopped ) {
            let update;
