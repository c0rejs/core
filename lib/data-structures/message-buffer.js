/* eslint-disable @corejslib/camel-case */
...
// |==========+==========+============================================================================|
// | ERROR    |      1:1 | @corejslib/camel-case, Definition for rule '@corejslib/camel-case' was not |
// |          |          | found.                                                                     |
// |----------+----------+----------------------------------------------------------------------------|
// | ERROR    |     74:5 | @c0rejs/camel-case, Identifier 'writeInt16BE' is not in camel case.        |
// |----------+----------+----------------------------------------------------------------------------|
// | ERROR    |     84:5 | @c0rejs/camel-case, Identifier 'writeUInt16BE' is not in camel case.       |
// |----------+----------+----------------------------------------------------------------------------|
// | ERROR    |     94:5 | @c0rejs/camel-case, Identifier 'writeInt32BE' is not in camel case.        |
// |----------+----------+----------------------------------------------------------------------------|
// | ERROR    |    104:5 | @c0rejs/camel-case, Identifier 'writeUInt32BE' is not in camel case.       |
// |----------+----------+----------------------------------------------------------------------------|
// | ERROR    |    114:5 | @c0rejs/camel-case, Identifier 'writeBigInt64BE' is not in camel case.     |
// |----------+----------+----------------------------------------------------------------------------|
// | ERROR    |    124:5 | @c0rejs/camel-case, Identifier 'writeBigUInt64BE' is not in camel case.    |
// +----------+----------+----------------------------------------------------------------------------+
// -----END LINT LOG-----
