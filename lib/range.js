...
// strictBoundaries - checks that "srart" and "end" are inside the provided content length
...
export default class Range {
    ...
    constructor ( { name, contentLength, start, end, length, inclusive, satisfiable, strictBoundaries } = {} ) {
        if ( name ) {
    ...
    hasValue ( value ) {
        ...
        else if ( value >= this.#start && ( this.#end == null || value < this.#end ) ) {
            return true;
        }
        else {
            return false;
