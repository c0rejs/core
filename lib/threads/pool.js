...
export default class ThreadsPool {
    ...
    set maxWaitingThreads ( value ) {
        if ( value !== Infinity ) {
            if ( value !== Infinity && ( !Number.isInteger( value ) || value < 0 ) ) throw new TypeError( "Semaphore maxWaitingThreads value must be integer >= 0 or Infinity" );
        }
    ...
    #setMaxRunningThreads ( value ) {
        if ( !Number.isInteger( value ) || value <= 0 ) throw new TypeError( "Semaphore maxRunningThreads value must be integer > 0" );
