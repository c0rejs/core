...
globalThis[ Symbol.for( "mainThreadArgv1" ) ] = workerData.mainThreadArgv1;
...
const { "default": Worker } = await import( workerData.module );

var worker;

if ( typeof Worker.new === "function" ) {
    worker = await Worker.new( ...( JSON.parse( workerData.args || "null" ) || [] ) );
}
else {
