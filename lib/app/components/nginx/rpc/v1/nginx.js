export default Super =>
    class extends Super {
        ...
        #onDisconnect ( connection ) {
            ...
            console.log( `[nginx] delete upstream, application: ${ app.id }, upstream: ${ upstream }` );
            ...
            for ( const proxy of app.proxies ) {
                ...
                if ( !proxy.upstreams.hasUpstreams ) {
                    ...
                    console.log( `[nginx] delete proxy, application: ${ app.id }, proxy: ${ proxy.id }` );
                }
            }
            ...
            if ( !app.connections.size ) {
                ...
                console.log( `[nginx] delete application, application: ${ app.id }` );
            }
        }
    };
