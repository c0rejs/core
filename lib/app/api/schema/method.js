...
export default class ApiMethod {
    ...
    #buildParamsValidator () {
        ...
        try {
            global[ Symbol.for( "aclResolver" ) ] = null;
            global[ Symbol.for( "ajvAttachmentMaxContentLength" ) ] = null;
            ...
            if ( global[ Symbol.for( "ajvAttachmentMaxContentLength" ) ] ) {
                this.#maxAttachmentContentLength = global[ Symbol.for( "ajvAttachmentMaxContentLength" ) ];
            }
            global[ Symbol.for( "ajvAttachmentMaxContentLength" ) ] = null;
