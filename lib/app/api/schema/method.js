...
export default class ApiMethod {
    ...
    validateParams ( params ) {
        try {
            ...
            const aclResolvers = aclResolverKeyword.aclResolvers;
    ...
    #buildParamsValidator () {
        ...
        try {
            ...
            this.#aclResolvers = aclResolverKeyword.aclResolverSchemas;
            this.#maxAttachmentContentLength = attachmentKeyword.maxContentLength;
