...
export default class ApiMethod {
    ...
    #buildParamsValidator () {
        ...
        try {
            ...
            global[ Symbol.for( "ajvMessageKeyword" ) ] = null;
            ...
            if ( global[ Symbol.for( "ajvFileKeyword" ) ] ) {
                this.#maxUploadSize = global[ Symbol.for( "ajvFileKeyword" ) ];
            }
            global[ Symbol.for( "ajvFileKeyword" ) ] = null;

            if ( global[ Symbol.for( "ajvMessageKeyword" ) ] ) {
                this.#maxUploadSize = global[ Symbol.for( "ajvMessageKeyword" ) ];
            }
            global[ Symbol.for( "ajvMessageKeyword" ) ] = null;
