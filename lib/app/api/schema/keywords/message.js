...
const keyword = {
    ...
    compile ( schema, parentSchema ) {
        ...
        if ( global[ Symbol.for( "ajvMessageMaxContentLength" ) ] == null ) {
            global[ Symbol.for( "ajvMessageMaxContentLength" ) ] = maxContentLength;
        }
        else if ( maxContentLength > global[ Symbol.for( "ajvMessageMaxContentLength" ) ] ) {
            global[ Symbol.for( "ajvMessageMaxContentLength" ) ] = maxContentLength;
        }
