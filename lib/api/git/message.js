...
export default class Priority {
    ...
    getChangelogSubject ( { withSemanticVersionType = true, withFixes = true, withLinks = true, withCommits = true, withAuthors = true } = {} ) {
        if ( !this.#changelogSubject ) {
            ...
            const fixes = withFixes
                    ...
                    : null,
                links = withLinks
                    ? [ ...this.links ].filter( link => !this.fixes.has( link ) ).join( ", " )
                    : null,
                commits = withCommits
            ...
            if ( authors ) tags.push( SYMBOLS.authors + " " + authors );
