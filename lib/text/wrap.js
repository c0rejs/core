...
class Wrap {
    ...
    #continueAnsiCode ( char ) {
        ...
        if ( char === "[" && this.#ansiCode.length === 2 && this.#ansiCode[ 0 ] === "\u{1B}" ) {
            return;
        }
    ...
    #addChar ( char ) {
        ...
        // add word char-by-char
            ...
            for ( let n = 0; n < this.#word.length; n++ ) {
                ...
                // ansi code
                if ( wordChar[ 0 ] === "\u{1B}" || wordChar[ 0 ] === "\u{9B}" ) {
                    wordAnsi += wordChar;
                    this.#line += wordChar;
                }
                else {
    ...
    #startLine ( wordAnsi ) {
        ...
        if ( this.#line && this.#ansiStyle ) this.#output += "\u{1B}[0m";
