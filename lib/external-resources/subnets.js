...
export default class TLD extends ExternalRecourceBuilder {
    ...
    // properties
    get id () {
        return "corejslib/core/resources/subnets";
    }
    ...
    // private
    async #build () {
        const subnets = yaml.fromYaml( await ( await fetch( "https://raw.githubusercontent.com/corejslib/core/main/resources/subnets.yaml" ) ).text() );
